...
Este repositorio contiene el código fuente del sitio web oficial de **GamaGar Solar**, una plataforma dedicada a ofrecer soluciones de alta ingeniería para la transición energética y movilidad sustentable en Monterrey, Nuevo León.
...
├── freeze.py           # Script para generar el sitio estático (.html)
├── templates/          # Plantillas Jinja2 (index.html, layout.html)
